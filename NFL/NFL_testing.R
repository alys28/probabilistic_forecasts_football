...
dataset_path <- "/Users/aly/Documents/University_of_Waterloo/Winter 2025/Research/code/NFL/test_6/svm_testing_combined_data.csv" # TO CHANGE
...
print(temp)
plot_pcb(df = temp, phat_A="ESPN", phat_B = "SVM") # TO CHANGE

write.csv(temp, file = "/Users/aly/Documents/University_of_Waterloo/Winter 2025/Research/code/NFL/test_6/svm_testing_L2.csv", row.names = FALSE) # TO CHANGE
x = tibble(
...
write.csv(x, file="/Users/aly/Documents/University_of_Waterloo/Winter 2025/Research/code/NFL/test_6/svm_testing_pval.csv") # TO CHANGE
