...
directory = "test_6/initial_probability_STRAW_MEN"  # Change this to your actual directory
...
if __name__ == "__main__":
    for filename in os.listdir(directory):
        if filename.endswith(".csv"):
            ...
            print(file_path)
            process_csv(file_path, "homeWinProbability", "inital_probability_phat_b", False, 0.005)  # Interpolate with 0.5% steps
