...
directory = "test_6/svm_testing"  # Change this to your actual directory
...
if __name__ == "__main__":
    for filename in os.listdir(directory):
        if filename.endswith(".csv"):
            ...
            print(file_path)
            process_csv(file_path, "homeWinProbability", "phat_b_SVM", False, 0.005)  # Interpolate with 0.5% steps
